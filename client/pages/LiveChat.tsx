  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      sender: "system",
      content: "Welcome to GlobalTrack Logistics support! How can we help you today?",
    ...
    },
    {
      id: "2",
      sender: "agent",
      content: "Hi there! I'm Sarah, your dedicated support specialist. I see you're interested in our shipping services. What specific questions do you have about your logistics needs?",
    ...
    },
    {
      id: "3",
      sender: "user",
      content: "Hello! I need help with tracking my recent shipment GT240001. It seems to be delayed.",
    ...
    },
    {
      id: "4",
      sender: "agent",
      content: "I'd be happy to help you track your shipment! Let me look up GT240001 for you right away. 📦",
    ...
    if (newMessage.trim()) {
      ...
      setTimeout(() => {
        ...
        const agentResponse: Message = {
          ...
          sender: "agent",
          content: "Thank you for your message! I'm reviewing the details and will provide you with an update shortly. 💫",
          timestamp: new Date(),
          status: "delivered",
          type: "text"
        };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <Card className="border-0 shadow-lg">
                <CardHeader className="pb-4">
                  <CardTitle className="text-lg">Your Support Specialist</CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{currentAgent.responseTime}</span>
                    </div>
                  </div>
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <a href="/help" className="flex items-center p-2 rounded-lg hover:bg-gray-50 transition-colors">
                      <HelpCircle className="h-5 w-5 mr-3 text-blue-600" />
                      <span className="text-sm">FAQ</span>
                    </a>
                    <a href="/track" className="flex items-center p-2 rounded-lg hover:bg-gray-50 transition-colors">
                      <FileText className="h-5 w-5 mr-3 text-green-600" />
                      <span className="text-sm">Track Shipment</span>
                    </a>
                    <a href="/services" className="flex items-center p-2 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <div className="lg:col-span-3">
              <Card className={`border-0 shadow-2xl transition-all duration-300 ${isMinimized ? 'h-16' : 'h-[600px]'}`}>
                {/* Chat Header */}
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs opacity-90">
                          {isTyping ? "Typing..." : `${currentAgent.name} is online`}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2">
              ...
              {!isMinimized && (
                <Card className="border-0 shadow-lg mt-4">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">How is your chat experience?</span>
                      <div className="flex space-x-2">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-800 mb-8">Why Choose Our Live Support?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Logistics experts with years of industry experience</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Quick responses and immediate problem resolution</p>
              </div>
            </div>
          </div>
        </div>
