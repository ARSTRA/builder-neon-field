      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Join thousands of businesses using GlobalTrack for their logistics
            needs
          </p>
        </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start space-x-3">
                          ...
                          >
                            ...
                            . I understand that my account will be reviewed for
                            verification. *
                          </Label>
                        </div>
                        {errors.acceptTerms && (
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          >
                            ...
                            shipping tips, and special offers from GlobalTrack
                            Logistics.
                          </Label>
                        </div>
                      </div>
