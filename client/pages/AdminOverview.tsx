      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
            Complete administrative control and management system for GlobalTrack Logistics. 
            All administrative functions have been consolidated into one powerful interface.
          </p>
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-800 mb-2">Single Access Point</h3>
                  <p className="text-sm text-gray-600">One login, complete access to all administrative functions</p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">Live system health and performance monitoring</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-3">
                    <BarChart3 className="h-6 w-6 text-white" />
                  </div>
                  <h3 className="font-semibold text-gray-800 mb-2">Comprehensive Analytics</h3>
                  <p className="text-sm text-gray-600">Unified reporting across all business functions</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-3">
                    <Zap className="h-6 w-6 text-white" />
                  </div>
                  <h3 className="font-semibold text-gray-800 mb-2">Streamlined Workflow</h3>
                  <p className="text-sm text-gray-600">Efficient management with categorized navigation</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="text-center mt-12 text-sm text-gray-500">
          ...
          <p>
            All administrative and management functions have been successfully consolidated into a single, 
            powerful interface for maximum efficiency and control.
          </p>
