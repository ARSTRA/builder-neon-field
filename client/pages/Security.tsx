  ...
  const securityMeasures = [
    {
      ...
      description:
        "AES-256 encryption for all data in transit and at rest, ensuring maximum protection.",
    ...
    },
    {
      ...
      description:
        "Advanced MFA with biometric and hardware token support for enhanced security.",
    ...
    },
    {
      ...
      description:
        "Continuous threat detection and real-time security incident response capabilities.",
    ...
    },
    {
      ...
      description:
        "Comprehensive identity verification and access management protocols.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="relative text-white overflow-hidden py-24 lg:py-32">
        ...
        <div
          className="absolute top-1/2 left-1/3 w-32 h-32 bg-gradient-to-br from-green-400/20 to-emerald-500/20 rounded-full blur-2xl animate-pulse-soft"
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-200 mb-8 max-w-4xl mx-auto leading-relaxed animate-fade-in-delay">
              🛡️ Enterprise-grade security protecting your data, operations, and
              business continuity with cutting-edge technology and
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              {certifications.map((cert, index) => (
                <Badge
                  key={index}
                  className={`bg-${cert.color}-500/20 text-${cert.color}-200 border-${cert.color}-400/50 px-6 py-3 text-lg backdrop-blur-sm`}
                >
            ...
            <div className="text-center">
              <p className="text-cyan-300 font-semibold text-lg">
                🏆 Trusted by 50,000+ companies worldwide • 🔒 Zero security
                breaches since 2015
              </p>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              {securityMeasures.map((measure, index) => (
                <Card
                  key={index}
                  className="group hover:shadow-2xl transition-all duration-500 border-0 overflow-hidden relative"
                >
                  <CardContent className="p-8 text-center">
                    <div
                      className={`w-20 h-20 bg-gradient-to-br ${measure.color} rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                    >
                      <div className="text-white">{measure.icon}</div>
                    </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {securityFeatures.map((feature, index) => (
                <Card
                  key={index}
                  className={`border border-${feature.color}-200 hover:shadow-xl transition-shadow duration-300`}
                >
                  <CardHeader className={`bg-${feature.color}-50`}>
                    <CardTitle
                      className={`text-${feature.color}-700 flex items-center`}
                    >
                      <div className={`text-${feature.color}-600 mr-3`}>
                        {feature.icon}
                      </div>
                      {feature.category}
                    </CardTitle>
                  ...
                  <CardContent className="p-6">
                    <ul className="space-y-3">
                      {feature.items.map((item, itemIndex) => (
                        ...
                        >
                          <CheckCircle
                            className={`h-4 w-4 mr-3 text-${feature.color}-500 flex-shrink-0`}
                          />
                          {item}
                        </li>
                      ))}
                  ...
                  <CardContent className="p-8 lg:p-12">
                    {activeSection === "overview" && (
                      <div className="space-y-8">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-6">
                          Security is at the core of everything we do at
                          ShipNexa.it. Our comprehensive security program
                          protects your data, ensures business continuity, and
                          maintains the highest standards of cyber security.
                        </p>
                          ...
                          <Card className="border border-green-200 bg-green-50">
                            <CardContent className="p-6 text-center">
                              ...
                              <p className="text-green-700">
                                No security incidents since our founding in 2015
                              </p>
                            </CardContent>
                          </Card>
                          <Card className="border border-blue-200 bg-blue-50">
                            <CardContent className="p-6 text-center">
                              ...
                              <p className="text-blue-700">
                                Multiple industry certifications and compliance
                              </p>
                            </CardContent>
                          </Card>
                          <Card className="border border-purple-200 bg-purple-50">
                            <CardContent className="p-6 text-center">
                              ...
                              <p className="text-purple-700">
                                Continuous security monitoring and threat
                                detection
                              </p>
                            </CardContent>
                          </Card>
                    ...
                    {activeSection === "infrastructure" && (
                      <div className="space-y-8">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-6">
                          Our infrastructure is built on enterprise-grade
                          security principles with multiple layers of protection
                    ...
                    {activeSection === "data" && (
                      <div className="space-y-8">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-6">
                          Your data is protected through comprehensive security
                              ...
                              <div className="grid md:grid-cols-3 gap-4">
                                <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                                  ...
                                  <p className="text-sm text-red-600">
                                    Highest security level with restricted
                                    access
                                  </p>
                                </div>
                                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                                  ...
                                  <p className="text-sm text-yellow-600">
                                    Protected internal business information
                                  </p>
                                </div>
                    ...
                    {activeSection === "access" && (
                      <div className="space-y-8">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-6">
                          Comprehensive access management ensuring only
                          authorized users can access systems and data based on
                    ...
                    {activeSection === "monitoring" && (
                      <div className="space-y-8">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-6">
                          Advanced security monitoring with AI-powered threat
                          detection, real-time alerting, and comprehensive
                          logging for complete visibility.
                        </p>
                    ...
                    {activeSection === "compliance" && (
                      <div className="space-y-8">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-6">
                          We maintain the highest standards of compliance with
                          industry regulations and security frameworks to ensure
                          your data is protected according to global standards.
                        </p>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          {[
                            ...
                            <Card
                              key={index}
                              className={`border border-${cert.color}-200 hover:shadow-lg transition-shadow duration-300`}
                            >
                              <CardHeader className={`bg-${cert.color}-50`}>
                                <CardTitle
                                  className={`text-${cert.color}-700 flex items-center justify-between`}
                                >
                                  <span>{cert.title}</span>
                                  <Badge
                                    className={`bg-${cert.color}-100 text-${cert.color}-700`}
                                  >
                                    {cert.status}
                                  </Badge>
                                </CardTitle>
                                <p className={`text-${cert.color}-600 text-sm`}>
                                  {cert.description}
                                </p>
                              </CardHeader>
                              <CardContent className="p-6">
                                <ul className="space-y-2">
                                  {cert.details.map((detail, detailIndex) => (
                                    ...
                                    >
                                      <CheckCircle
                                        className={`h-4 w-4 mr-3 text-${cert.color}-500 flex-shrink-0`}
                                      />
                                      {detail}
                                    </li>
                                  ))}
                    ...
                    {activeSection === "incident" && (
                      <div className="space-y-8">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-6">
                          Our comprehensive incident response program ensures
                          rapid detection, containment, and recovery from
                          security incidents with minimal business impact.
                        </p>
                    ...
                    {activeSection === "contact" && (
                      <div className="space-y-8">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-6">
                          Found a security vulnerability? We appreciate
                          responsible disclosure and will work with you to
                        ...
                        <div className="bg-red-50 p-6 rounded-xl border-l-4 border-red-500 mb-6">
                          ...
                          <p className="text-red-700 mb-4">
                            For immediate security emergencies, contact our 24/7
                            security hotline:
                          </p>
                          <Button
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <Card className="border border-blue-200 hover:shadow-md transition-shadow duration-200">
                            <CardContent className="p-6">
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  window.open(
                                    "mailto:security@shipnexa.it?subject=Security Inquiry",
                                    "_blank",
                                  )
                                }
                              >
                          ...
                          <Card className="border border-green-200 hover:shadow-md transition-shadow duration-200">
                            <CardContent className="p-6">
                              ...
                              <p className="text-gray-600 mb-4">
                                Earn rewards for responsible disclosure
                              </p>
                              <Button
                                variant="outline"
                                ...
                                onClick={() => {
                                  toast({
                                    ...
                                    description:
                                      "We offer rewards from $100 to $10,000 for responsible security disclosures. Contact security@shipnexa.it for more details.",
                                  });
                                }}
                              >
                                Learn More
                          ...
                          <CardContent className="p-6">
                            <ul className="space-y-3 text-gray-600">
                              <li className="flex items-start">
                                ...
                                <span>
                                  Report vulnerabilities through our official
                                  channels
                                </span>
                              </li>
                              <li className="flex items-start">
                                <CheckCircle className="h-5 w-5 mr-3 mt-0.5 text-green-500 flex-shrink-0" />
                                <span>
                                  Provide detailed reproduction steps and impact
                                  assessment
                                </span>
                              </li>
                              <li className="flex items-start">
                                <CheckCircle className="h-5 w-5 mr-3 mt-0.5 text-green-500 flex-shrink-0" />
                                <span>
                                  Allow us reasonable time to investigate and
                                  fix issues
                                </span>
                              </li>
                              <li className="flex items-start">
                                <CheckCircle className="h-5 w-5 mr-3 mt-0.5 text-green-500 flex-shrink-0" />
                                <span>
                                  Do not access or modify user data during
                                  testing
                                </span>
                              </li>
                            </ul>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Your data security is our top priority. Experience
              enterprise-grade protection with ShipNexa.it.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                onClick={() =>
                  window.open(
                    "mailto:security@shipnexa.it?subject=Security Team Contact Request",
                    "_blank",
                  )
                }
              >
