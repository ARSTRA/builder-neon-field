...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Package, Shield, CheckCircle, User } from "lucide-react";
      ...
      <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign in to your account to manage your shipments</p>
          </div>

          <Card className="shadow-2xl border-0 bg-white">
            <CardHeader className="pb-4">
              <CardTitle className="text-center text-xl text-gray-800">Sign In</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between text-sm">
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input type="checkbox" className="rounded border-gray-300 text-royal-600 focus:ring-royal-500" />
                    <span className="text-gray-600">Remember me</span>
                  </label>
                  <Link to="/forgot-password" className="text-royal-600 hover:text-royal-700 font-medium">
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="text-center">
                <p className="text-gray-600">
                  ...
                  <Link to="/register" className="text-royal-600 hover:text-royal-700 font-medium">
                    Sign up here
                  </Link>
                </p>
              </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link to="/terms" className="text-royal-600 hover:text-royal-700">Terms of Service</Link>
            {" "}and{" "}
            <Link to="/privacy" className="text-royal-600 hover:text-royal-700">Privacy Policy</Link>
          </p>
        </div>
          ...
          <div className="bg-gradient-to-br from-royal-600 to-royal-800 rounded-3xl p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-gray-200 mb-8 leading-relaxed">
                Access your personalized dashboard to track packages, manage payments, 
                and get real-time updates on all your logistics needs.
              </p>
              ...
              <div className="mt-8 p-6 bg-white/10 backdrop-blur-sm rounded-xl">
                <div className="flex items-center space-x-4">
                  <div className="flex -space-x-2">
                    <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face" alt="User" className="w-10 h-10 rounded-full border-2 border-white" />
                    <img src="https://images.unsplash.com/photo-1494790108755-2616b332c3f2?w=40&h=40&fit=crop&crop=face" alt="User" className="w-10 h-10 rounded-full border-2 border-white" />
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face" alt="User" className="w-10 h-10 rounded-full border-2 border-white" />
                  </div>
                  <div>
