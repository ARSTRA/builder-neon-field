        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center space-x-2 mb-6">
              <div className="w-10 h-10 bg-royal-600 rounded-lg flex items-center justify-center">
                ...
                >
                  {isLoading ? (
                    <>
                      ...
                      {isAdminAccess ? "Authenticating..." : "Signing In..."}
                    </>
                  ) : (
                    <>
                      {isAdminAccess ? (
          ...
          {!isAdminAccess && (
            <div className="text-center mt-6">
              <Link
                to="/login?admin=true"
                className="text-sm text-gray-500 hover:text-royal-600 transition-colors"
              >
