...
const defaultPlatforms: SocialMediaPlatform[] = [
  {
    ...
    platform: "facebook",
    icon: Facebook,
    url: "https://facebook.com/shipnexa.it",
    username: "@shipnexa.it",
    followers: "12.5K",
    enabled: true,
  ...
  },
  {
    ...
    platform: "instagram",
    icon: Instagram,
    url: "https://instagram.com/shipnexa.it",
    username: "@shipnexa.it",
    followers: "15.7K",
    enabled: true,
    displayInFooter: true,
  ...
  },
  {
    ...
    platform: "linkedin",
    icon: Linkedin,
    url: "https://linkedin.com/company/shipnexa-it",
    username: "shipnexa-it",
    followers: "22.1K",
    enabled: true,
    displayInFooter: true,
  ...
  },
  {
    ...
    platform: "youtube",
    icon: Youtube,
    url: "https://youtube.com/@shipnexa.it",
    username: "@shipnexa.it",
    followers: "5.2K",
    enabled: true,
    displayInFooter: true,
