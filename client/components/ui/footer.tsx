        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-6">
              ...
              <div>
                <span className="text-xl font-bold text-white">GlobalTrack</span>
                <span className="text-lg text-orange-500 ml-1">Logistics</span>
              </div>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Your trusted partner for global shipping solutions. We provide fast, 
              secure, and reliable logistics services worldwide with real-time tracking.
            </p>
          ...
          {/* Contact Information */}
          <div>
            <h3 className="text-lg font-semibold mb-6 text-orange-500">Contact Information</h3>
