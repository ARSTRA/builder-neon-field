...
export function ChatOnlyWidget({
  className,
  theme = {
    primaryColor: "#2563eb",
  ...
  const [messages, setMessages] = useState<Message[]>([
    ...
    },
    {
      ...
      sender: "agent",
      content:
        "Hi there! I'm Sarah, your support specialist. Ready to help with tracking, quotes, or any questions. What would you like to know?",
    ...
    if (newMessage.trim()) {
      ...
      setTimeout(() => {
        ...
        const agentResponse: Message = {
          ...
          sender: "agent",
          content:
            "Thank you for your message! I'm here to help you with that. Let me provide you with the assistance you need. 💬",
          timestamp: new Date(),
          status: "delivered",
          type: "text",
          agentName: currentAgent.name,
  ...
  // Floating chat button positioned at right end
  if (!isOpen) {
    return (
      <div className="fixed right-0 bottom-6 z-50">
        <style>{`
          .chat-button-right-end {
        ...
        `}</style>
        <TooltipProvider>
          <div className="chat-button-right-end">
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  {/* Unread count badge */}
                  {unreadCount > 0 && (
                    <Badge className="absolute -top-2 -left-2 h-6 w-6 rounded-full bg-red-500 text-white border-2 border-white text-xs flex items-center justify-center">
                      {unreadCount > 9 ? "9+" : unreadCount}
                    </Badge>
                  )}
                  
                  {/* Online indicator */}
                  <div className="absolute -bottom-1 -left-1 h-5 w-5 bg-green-500 rounded-full border-2 border-white">
              ...
              <TooltipContent side="left" className="mr-4">
                <div className="text-center">
                  <p className="font-medium">Chat with our support team</p>
                  {currentAgent.isOnline && (
                    <p className="text-xs text-green-600 mt-1">
                      {currentAgent.name} is online • Response time: {currentAgent.responseTime}
                    </p>
                  )}
                </div>
              </TooltipContent>
  ...
  // Chat interface positioned at right end
  return (
    <div className="fixed right-0 bottom-6 z-50">
      <style>{`
        .chat-widget-right-end {
          position: fixed !important;
          right: 0px !important;
          bottom: 24px !important;
          transform: translateX(-8px);
      ...
      <Card
        className={cn(
          "chat-widget-right-end shadow-2xl border-0 transition-all duration-300 backdrop-blur-sm",
          isMinimized ? "w-80 h-20" : "w-96 h-[600px]"
        )}
        style={{ backgroundColor: theme.backgroundColor }}
      >
        {/* Header - Chat Only Design */}
        <CardHeader
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-sm truncate">💬 ShipNexa Chat Support</h3>
                <p className="text-xs opacity-90 truncate">
                  {isTyping ? (
                    ...
                    <span className="flex items-center">
                      ...
                      {currentAgent.name} • Online • {currentAgent.responseTime} response
                    </span>
                  )}
                </p>
              </div>
          ...
          <>
            ...
            <div className="border-t bg-gray-50/50 p-4 rounded-b-lg">
              ...
              <div className="flex items-center justify-between mt-3 text-xs text-gray-500">
                <span>💬 Chat Support - ShipNexa</span>
