...
export function PaymentsSection() {
  ...
  const getCardIcon = (type: string) => {
    ...
    switch (type) {
      case "visa":
        return <div className={`${baseClasses} bg-blue-600 flex items-center justify-center text-white text-xs font-bold`}>VISA</div>;
      case "mastercard":
        return <div className={`${baseClasses} bg-red-600 flex items-center justify-center text-white text-xs font-bold`}>MC</div>;
      case "amex":
        return <div className={`${baseClasses} bg-green-600 flex items-center justify-center text-white text-xs font-bold`}>AMEX</div>;
      default:
            ...
            <DialogContent className="max-w-md">
              ...
              <form className="space-y-4">
                ...
                <div className="flex justify-end space-x-3 pt-4">
                  <Button type="button" variant="outline" onClick={() => setIsAddCardModalOpen(false)}>
                    Cancel
                  </Button>
        ...
        <TabsContent value="cards" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {paymentMethods.map((card) => (
              <Card key={card.id} className={`relative border-2 transition-all duration-200 hover:shadow-lg ${
                card.isDefault ? "border-royal-200 bg-royal-50" : "border-gray-200"
              }`}>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-sm text-gray-500">Expires {card.expiryMonth}/{card.expiryYear}</div>
                    {card.nickname && (
                      <div className="text-sm font-medium text-gray-700">{card.nickname}</div>
                    )}
                  </div>
                </CardContent>
              </Card>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex space-x-2">
                        ...
                        {invoice.status === "pending" && (
                          <Button size="sm" className="bg-royal-600 hover:bg-royal-700">
                            Pay Now
                          </Button>
                        )}
                      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Automatically pay invoices using your default payment method</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Receive email notifications for invoices and payments</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get reminders before payment due dates</p>
                  </div>
                  <Switch defaultChecked />
                </div>
              </div>
