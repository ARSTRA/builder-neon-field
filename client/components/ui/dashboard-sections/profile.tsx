        ...
        <div className="mt-4 sm:mt-0 flex space-x-3">
          {isEditing ? (
            <>
              ...
              <Button onClick={handleSave} className="bg-gradient-to-r from-royal-600 to-orange-500 hover:from-royal-700 hover:to-orange-600">
                <Save className="h-4 w-4 mr-2" />
                Save Changes
              </Button>
            </>
          ) : (
            <Button onClick={() => setIsEditing(true)} className="bg-gradient-to-r from-royal-600 to-orange-500 hover:from-royal-700 hover:to-orange-600">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <Select value={profileData.country} onValueChange={(value) => handleInputChange("country", value)} disabled={!isEditing}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <div>
                  ...
                  <Select disabled={!isEditing}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="501-1000">501-1000 shipments</SelectItem>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Mobile App • New York, NY</p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Receive news and offers from GlobalTrack</p>
                    </div>
                    <Switch />
                  </div>
                </div>
