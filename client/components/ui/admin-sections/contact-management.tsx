  ...
  const contacts = [
    {
      ...
      message: "Hello, I'm interested in your air freight services for our upcoming shipment to Europe. Could you please provide a quote for 500kg of electronics equipment?",
      status: "open",
      priority: "high",
      type: "inquiry",
    ...
    },
    {
      ...
      message: "I'm having trouble tracking my shipment GT240001. The last update was 3 days ago and I need to know the current status urgently.",
      status: "in_progress",
      priority: "urgent",
      type: "support",
    ...
    },
    {
      ...
      message: "We're looking for a long-term partnership for our monthly shipments from Asia to North America. Approximately 10 containers per month.",
      status: "closed",
      priority: "medium",
      type: "quote",
    ...
    },
    {
      ...
      message: "Our shipment was supposed to arrive 3 days ago but it's still in transit. This is causing significant delays in our production schedule.",
      status: "escalated",
      priority: "urgent",
      type: "complaint",
  ...
  const templates = [
    {
      ...
      content: "Thank you for your interest in GlobalTrack Logistics. We have prepared a competitive quote based on your requirements...",
    },
    {
      id: "2",
      name: "Tracking Update",
      subject: "Tracking Update for Your Shipment",
      content: "We wanted to provide you with an update on your shipment. Your package is currently...",
    },
    {
      id: "3",
      name: "Delivery Confirmation",
      subject: "Your Shipment Has Been Delivered",
      content: "Great news! Your shipment has been successfully delivered. Here are the delivery details...",
    },
  ];
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent>
                            <DropdownMenuItem onClick={() => handleReply(contact.id)}>
                              <Reply className="h-4 w-4 mr-2" />
                              Reply
                            </DropdownMenuItem>
                            <DropdownMenuItem onClick={() => handleAssign(contact.id, "New Agent")}>
                              <User className="h-4 w-4 mr-2" />
                              Assign
                            </DropdownMenuItem>
                            <DropdownMenuItem onClick={() => handleStatusUpdate(contact.id, "closed")}>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Input id="response-time" type="number" defaultValue="2" className="mt-1" />
                  </div>
                </div>
              </div>
          ...
          <DialogContent className="sm:max-w-[700px]">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600 bg-gray-50 p-4 rounded-lg">{selectedMessage.message}</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium capitalize">{selectedMessage.type}</p>
                </div>
              </div>
